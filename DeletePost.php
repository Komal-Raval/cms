                    ...
                    <div class="card bg-secondary text-light mb-3">
                        ...
                        <div class="card-body bg-dark">
                            <div class="form-group">
                                ...
                                <input disabled class="form-control" type="text" name="PostTitle" id="title" placeholder="Type title hear" value="<?php echo $TitleToBeDeleted; ?>">
                            </div>
                            <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 mb-2">
                                    <button type="submit" name="Submit" value="submit" class="btn btn-danger btn-block">
                                      Delete
                                    </button>
                                </div>
                            </div>
